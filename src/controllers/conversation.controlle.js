...
class ConversationController {
  ...
  async rename(req, res) {
    ...
    try {
      const newConversation = await conversationService.rename(user, id, title);
      return res.success(newConversation);
    } catch (err) {
  ...
  async getOne(req, res) {
    ...
    try {
      const conversation = await conversationService.getOne(user, conversationId);
  ...
  async getMessage(req, res) {
    ...
    try {
      const messages = await conversationService.getMessage(user, conversationId, limit, offset);
  ...
  async createMessage(req, res) {
    ...
    try {
      const userMessage = await conversationService.create(conversationId, user, message, "user");
      chatBotService
  ...
  async editMessage(req, res) {
    ...
    try {
      await conversationService.edit(conversationId, user, messageId, message);
